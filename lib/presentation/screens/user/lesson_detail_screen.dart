        ...
        builder: (context, constraints) {
          final text = Column(
            ...
            children: [
              ...
              Text(
                'Learn the idea in short sections, apply it to a realistic situation, then check your understanding.',
        ...
        builder: (context, constraints) {
          final text = Column(
            ...
            children: [
              ...
              const SizedBox(height: AppSpacing.xs),
              Text(
                'PromptWise will choose questions based on this topic, your current progress, and the difficulty you have already handled.',
                style: theme.textTheme.bodyMedium?.copyWith(
