    ...
    if (adaptive.diagnosticCompleted) {
      return Scaffold(
        appBar: const PromptWiseAppBar(
          eyebrow: 'LEARN · GET STARTED',
          title: 'Starting Check',
          subtitle: 'A short check that helps PromptWise recommend where to begin.',
          backTooltip: 'Back',
        ),
        body: AdaptiveBody(
                ...
                child: AppCard(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Starting check already completed',
                        style: Theme.of(context).textTheme.titleLarge,
                      ),
                      const SizedBox(height: AppSpacing.sm),
                      const Text(
                        'Your starting check is already saved. Continue with lessons and knowledge checks to update your progress.',
                      ),
              ...
              child: Column(
                ...
                children: [
                  PageIntro(
                    ...
                    description:
                        'This short starting check helps PromptWise understand your level. It does not affect your regular quiz score.',
                  ),
                  const SizedBox(height: AppSpacing.lg),
