    ...
    return PopScope(
      ...
      child: Scaffold(
        appBar: PromptWiseAppBar(
          eyebrow: widget.args.mode == 'review'
              ? 'PRACTICE · REVIEW'
              : 'PRACTICE · ADAPTIVE CHECK',
          title: widget.args.mode == 'review'
              ? 'Review Check'
              : 'Knowledge Check',
          subtitle: 'Work through the questions, then review what to focus on next.',
          backTooltip: 'Back to Practice',
        ),
        body: AdaptiveBody(
        ...
        children: [
          ...
          Text(
            feedback.countedForMastery
                ? 'This answer helped update your progress.'
                : 'This answer was saved as practice, but repeating it right away did not increase progress again.',
            style: Theme.of(context).textTheme.bodySmall?.copyWith(
                  color: Theme.of(context).colorScheme.onSurfaceVariant,
                ),
          ),
              ...
              AppCard(
                ...
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: AppSpacing.sm),
                    Text(
                      'PromptWise used your answers to update your skill progress and learning path.',
                      textAlign: TextAlign.center,
                      style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                            color:
